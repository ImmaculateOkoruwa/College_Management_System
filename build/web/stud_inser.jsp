...
<%@page import="Dbcon.FileUploadDB"%>
<!doctype html>
<html>
    <head>
        ...
        <div id="container" class="width">
            ...
            <%int maxID = 0;
                ...
                try {
                    ...
                    rs = st.executeQuery("SELECT MAX(id) FROM stud_info");
                    while (rs.next()) {

                        maxID = rs.getInt(1);
                        int id = maxID + 1;
                        String string = "ST00" + id;
            ...
            <div id="intro">
                <div class="width">
                    <div class="intro-content">
                        ...
                        <%----- Start body-----%>
                        <br><br><center><h2 style="font-size: 26px; color: #00A6EB; font-family: cursive">INSERT STUDENT INFORMATION</h2>
                            <br><form method="post" action="FileUploadDB" enctype="multipart/form-data">
                                <input type="text" class="inputs" name="sid" required="" value="<%=string%>" readonly="" />&nbsp;&nbsp;&nbsp; 
                                <% }
                                    } catch (Exception ex) {
                                        ex.printStackTrace();
                                    }%>
                                <input type="text" class="inputs" name="sname" required="" placeholder="Student Name" /><br> 
                                <input type="text" class="inputs" name="dob" required="" placeholder="DOB(eg.01/01/1990)" />&nbsp;&nbsp;&nbsp;
                                <input type="email" class="inputs" name="email" required="" placeholder="Email ID" /><br> 


                                <select class="inputss" required="" name="depart" >
                                ...
                                <input type="text" class="inputs" name="street" required="" placeholder="Street" /><br> 
