...
<%
    ...
    String id = null, dname = null, yoc = null, seats = null, yocc = null;
    ...
    try {
        ...
        session.setAttribute("idddddd", idd);
        System.out.println("idd >>-------------------->>>: " + idd);

        String s = "select dname,yoc from depart where id='" + idd + "'";
            ...
            <div id="intro">
                <div class="width">
                    <div class="intro-content">
                        <h2 style="font-size: 26px; color: #00A6EB; font-family: cursive">DEPARTMENT UPDATE</h2><BR>
                        <%----- Start body-----%>
                        <form action="login_2.jsp" method="get">
                            <center><table>
                                    <tr><td>Department:<input type="text" name="dname" value="<%=dname%>"  size="25"/></td></tr>
                                    <tr><td>Year: <input type="text" name="yoc" value="<%=yoc%>"  size="8" /></td></tr>
