...
<%
String sid=(String)session.getAttribute("sssstaff");
        %>
                        <%----- Start body-----%>
                        <center><h2 style="font-size: 26px; color: #00A6EB; font-family: cursive">STAFF DAILY STATUS</h2>
                            <br><form method="get" action="login.jsp" >
                                <select class="inputss" required="" name="departments" >
                                ...
                                %><br>
                                <select class="inputss" required="" name="sections" >
                                    <option value="">Section</option>
                                    <option value="A01">A01</option>
                                    <option value="A02">A02</option>
                                </select><br>
                                <input type="text" class="inputs" name="staffidd" value="<%=sid%>" /><br> 
                                <input type="date" class="inputs" name="datee"  placeholder="Date" /><br> 
                                <input type="text" class="inputs" name="subj"  placeholder="Subject Name" /><br>  
                                <input type="text" class="inputs" name="year"  placeholder="Year(eg.I or II)" /><br> <br>  
