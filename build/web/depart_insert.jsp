                    ...
                    <div class="intro-content">
                        <%int maxID = 0;
                            ...
                            try {
                                ...
                                rs = st.executeQuery("SELECT MAX(id) FROM depart");
                                while (rs.next()) {

                                    maxID = rs.getInt(1);
                                    int id = maxID+1;
                                  
                                    System.out.println("id valus: " + id);


                        %>
                        <!--<img src="img/ad.jpg" style="height: 400px; width: 920px" alt="">-->
                        <%----- Start body-----%>
                        <br><br><center><h2 style="font-size: 26px; color: #00A6EB; font-family: cursive">INSERT DEPARTMENT</h2>
                            <br><form action="login.jsp" method="get"> 
                                <input type="text" class="inputs" name="id" readonly=""  value="<%=id%>"/>&nbsp;&nbsp;&nbsp; 

                                <% }
                                    } catch (Exception ex) {
                                        ex.printStackTrace();
                                    }%><input type="text" class="inputs" name="dname" required="" placeholder="Department Name" /><br> 
                                <input type="text" class="inputs" name="yoc" required="" placeholder="Year of Creation" />&nbsp;&nbsp;&nbsp;<br>
