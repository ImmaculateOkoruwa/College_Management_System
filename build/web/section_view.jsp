            ...
            <div id="intro">
                <div class="width">
                    <div class="intro-content">
                        ...
                        <%----- Start body-----%>
                       <center><h2 style="font-size: 26px; color: #00A6EB; font-family: cursive">SECTION DETAILS</h2>
                            <br><table border="2" style="text-align: center; margin-left: 0px; border-color: black">
                                <tr>
                                    ...
                                    <th style="text-align: center;width: 200px;  font-size: 16px; color: #000">Course Name</th>
                                    <th style="text-align: center;width: 200px;  font-size: 16px; color: #000">Section ID</th>
                                    <th style="text-align: center;width: 200px;  font-size: 16px; color: #000">Seats</th>
                                ...
                                <tr>
                                    <%
                                        ...
                                        try {
                                            ...
                                            while (rs.next()) {
                                    %>
                                    <td style="font-size: 16px; color: black"><br><%=rs.getString("id")%></td>   
                                    <td style="font-size: 16px; color: blueviolet"><br><%=rs.getString("cname")%></td>  
                                    <td style="font-size: 16px; color: darkblue"><br><%=rs.getString("sectionid")%></td>  
                                    <td style="font-size: 16px; color: black"><br><%=rs.getString("seats")%></td>  
                                    <td style="font-size: 16px; color: blueviolet"><br><%=rs.getString("yocc")%></td> 
                                    <td> <a href="selection_edit.jsp?id=<%=rs.getString("id")%>"><font style="color: green">Edit</a></font> </td>
                                    <td> <a href="remove1.jsp?<%=rs.getString("id")%>"><font style="color: green">Click</a></font> </td>
                                </tr>
                                <%
