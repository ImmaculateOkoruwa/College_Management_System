            ...
            <div id="intro">
                <div class="width">
                    <div class="intro-content">
                        ...
                        <%----- Start body-----%>
                        <center><h2 style="font-size: 26px; color: #00A6EB; font-family: cursive">STAFF REPORT DETAILS</h2>
                            <br><table border="2" style="text-align: center; margin-left: 0px; border-color: black">
                                <tr>
                                    <th style="text-align: center;width: 400px;  font-size: 16px; color: #000">S. No:</th>
                                    ...
                                    <th style="text-align: center;width: 300px;  font-size: 16px; color: #000">Date</th>
                                    <th style="text-align: center;width: 200px;  font-size: 16px; color: #000">Subject</th>
                                    <th style="text-align: center;width: 200px;  font-size: 16px; color: #000">Year</th>
                                ...
                                <tr>
                                    ...
                                    <td style="font-size: 16px; color: blueviolet; font-size: 20px"><br><%=rs.getString("departments")%></td>  
                                    <td style="font-size: 16px; color: darkblue; font-size: 20px"><br><%=rs.getString("sections")%></td> 
                                    <td style="font-size: 16px; color: black; font-size: 20px"><br><%=rs.getString("staffidd")%></td>   
                                    <td style="font-size: 16px; color: blueviolet; font-size: 20px"><br><%=rs.getString("datee")%></td>  
                                    <td style="font-size: 16px; color: darkblue; font-size: 20px"><br><%=rs.getString("subj")%></td> 
                                    <td style="font-size: 16px; color: darkblue; font-size: 20px"><br><%=rs.getString("year")%></td> 
                                    <td> <a href="remove4.jsp?<%=rs.getString("id")%>"><br><font style="color: green">Click</a></font> </td>
                                </tr>
                                <%
