                ...
                <div class="width"><br>
                    ...
                    <nav>
                        ...
                        <ul class="sf-menu dropdown">
                            ...
                            <li class="selected"><a href="announ_ad.jsp">Admin Announcement</a></li>
            ...
            <div id="intro">
                <div class="width">
                    <div class="intro-content">
                        ...
                        <%----- Start body-----%>
                        <center><h2 style="font-size: 26px; color: #00A6EB; font-family: cursive">ANNOUNCEMENTS OF ADMIN</h2>
                                ...
                                <tr>
                                    <%
                                        ...
                                        try {
                                            ...
                                            rs = st.executeQuery("select * from admin_announ");
                                            while (rs.next()) {%>
                                    <td style="font-size: 16px; color: black; font-size: 20px"><br><%=rs.getString("id")%></td>   
                                    <td style="font-size: 16px; color: blueviolet; font-size: 20px"><br><%=rs.getString("date")%></td>  
