            ...
            <div id="intro">
                <div class="width">
                    <div class="intro-content">
                        ...
                        <%----- Start body-----%>
                        <BR><BR><center><h2 style="font-size: 26px; color: #00A6EB; font-family: cursive"> STUDENT INSERT</h2>
                            <br><form method="get" action="mark_insert1.jsp" >
                                ...
                                %>&nbsp;&nbsp;&nbsp;
                                <select class="inputss" required="" name="class" >
