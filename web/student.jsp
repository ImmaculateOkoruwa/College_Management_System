                ...
                <div class="width"><br>
                    ...
                    <nav>
                        ...
                        <ul class="sf-menu dropdown">
                            ...
                            <li class="selected"><a href="student.jsp">Student Login</a></li>
            ...
            <div id="intro">
                <div class="width">
                    <div class="intro-content">
                        <img src="images/st1.jpg" style="height: 400px; width: 920px" alt="">
                        <%----- Start body-----%>
                        <br><br><center><h2 style="font-size: 28px; color: #003da6; font-family: New Century Schoolbook, serif">STUDENT LOGIN</h2>
                            <br><form method="get" action="login.jsp">
                                <input type="text" class="inputs" name="uname" required="" placeholder="Student ID"/><br> <br>  
